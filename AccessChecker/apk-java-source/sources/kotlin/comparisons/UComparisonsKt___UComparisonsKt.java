...
public class UComparisonsKt___UComparisonsKt {
    ...
    public static final int m1353maxOfMd2H83M(int a, int... other) {
        ...
        int max = a;
        int m313getSizeimpl = UIntArray.m313getSizeimpl(other);
        for (int i = 0; i < m313getSizeimpl; i++) {
            int e = UIntArray.m312getpVg5ArA(other, i);
    ...
    public static final long m1354maxOfR03FKyM(long a, long... other) {
        Intrinsics.checkNotNullParameter(other, "other");
        long max = a;
        int m392getSizeimpl = ULongArray.m392getSizeimpl(other);
        for (int i = 0; i < m392getSizeimpl; i++) {
            long e = ULongArray.m391getsVKNKU(other, i);
    ...
    public static final byte m1357maxOfWr6uiD8(byte a, byte... other) {
        Intrinsics.checkNotNullParameter(other, "other");
        byte max = a;
        int m234getSizeimpl = UByteArray.m234getSizeimpl(other);
        for (int i = 0; i < m234getSizeimpl; i++) {
            byte e = UByteArray.m233getw2LRezQ(other, i);
    ...
    public static final short m1361maxOft1qELG4(short a, short... other) {
        Intrinsics.checkNotNullParameter(other, "other");
        short max = a;
        int m497getSizeimpl = UShortArray.m497getSizeimpl(other);
        for (int i = 0; i < m497getSizeimpl; i++) {
            short e = UShortArray.m496getMh2AYeg(other, i);
